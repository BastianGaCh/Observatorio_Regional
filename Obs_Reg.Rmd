...
dat$alcalde <- ifelse(dat$Comuna == "Coltauco", "Ruben Jorquera Vidal", NA)
dat$alcalde <- ifelse(dat$Comuna == "Doñihue", "Ricardo Boris Acuña González", NA)
dat$alcalde <- ifelse(dat$Comuna == "Graneros", "Claudio Segovia Cofre", NA)
dat$alcalde <- ifelse(dat$Comuna == "Machalí", "José Miguel Urrutia Celis", NA)
dat$alcalde <- ifelse(dat$Comuna == "Mostazal", "Sergio Medel Acosta", NA)
dat$alcalde <- ifelse(dat$Comuna == "Rengo", "Carlos Soto González", NA)
dat$alcalde <- ifelse(dat$Comuna == "Requínoa", "Luis Antonio Silva Vargas", NA)
dat$alcalde <- ifelse(dat$Comuna == "San Vicente", "Jaime González Ramírez", NA)
dat$alcalde <- ifelse(dat$Comuna == "San Fernando", "Luis Berwart Araya ", NA)
